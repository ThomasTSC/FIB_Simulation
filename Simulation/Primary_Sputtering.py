...
class Primary_Sputtering:
    ...
    def primarySputtering(self,Beam_Position_X,Beam_Position_Y):
        ...
        Primary_Ion_Beam = Primary_Sputtering(self.Profile).primaryIonBeamProfile()
        
        Diluted_Ion_Beam_Effect = Primary_Sputtering(self.Profile).dilutedIonBeamEffect()
        
        Sputtering_Yield = Primary_Sputtering(self.Profile).sputteringYield()
